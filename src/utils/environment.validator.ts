...
export async function validateEnvironment(
  ...
  try {
    ...
    checkPoint.dtEnvFile = checkDtEnvFile(TARGET_DIR, targetEnvironment, doForce)
  } catch (error) {
  ...
  try {
    ...
    checkPoint.awsCredentials = validateAwsCredentials(TARGET_DIR, targetEnvironment)
  } catch (error) {
  ...
  try {
    ...
    checkPoint.requiredVariables = validateRequiredVariables(TARGET_DIR, targetEnvironment)
  } catch (error) {
  ...
  try {
    ...
    checkPoint.requiredTools = await validateRequiredTools()
  } catch (error) {
...
async function validateRequiredTools(): Promise<boolean> {
